...
\usepackage{
	geometry, subfigure,
	rotating,	listings,	hyperref,	float,		url,
	appendix,	supertabular, multicol
}
...
\begin{figure*}[htbp]
	\begin{center}
    \mbox{
    \subfigure[Average QPS]{
    	\label{fig:res31}
    	    	\input{bench.tex}
		%\includegraphics[width=0.75\textwidth]{../Master/include/expsum/levels/8_qps}
	}
	}
